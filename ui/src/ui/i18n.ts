...
const STRINGS = {
  ...
  "cloud.uniform": { th: "ทุกแท็กถูกใช้เท่ากัน", en: "every tag is used equally often" },
  "nav.traces": { th: "รอยที่ถูกถาม", en: "trace log" },
  "nav.traces.title": { th: "ทุกครั้งที่ถูกถาม และได้อะไรกลับไป", en: "every call that arrived, and what came back" },
  "trace.eyebrow": { th: "TRACE LOG", en: "TRACE LOG" },
  "trace.title": { th: "อะไรถูกถามบ้าง", en: "What was asked" },
  "trace.blurb": {
    th: "ทุกการเรียกเครื่องมือ และทุกการอ่านที่มีเจตนา — รวมถึงครั้งที่พังและครั้งที่ไม่เจออะไรเลย กดแถวเพื่อดูสิ่งที่ส่งมาจริง",
    en: "Every tool call and every read that carried an intent — including the ones that failed and the ones that found nothing. Open a row to see what was actually sent.",
  },
  "trace.off": {
    th: "ไม่ได้บันทึกอยู่ ตั้ง trace_log ในหน้า settings เพื่อเริ่มเก็บ",
    en: "Recording is off. Set trace_log in the settings to start keeping a record.",
  },
  "trace.search": { th: "ค้นในเครื่องมือ คำที่ถาม โหมด หรือข้อผิดพลาด…", en: "Search the tool, subject, mode or error…" },
  "trace.empty": { th: "ยังไม่มีอะไรถูกบันทึก", en: "Nothing recorded yet." },
  "trace.recorded": { th: "ทั้งหมด", en: "recorded" },
  "trace.hits": { th: "ผล", en: "hit(s)" },
  "trace.written": { th: "เขียน", en: "written" },
  "trace.asked": { th: "ถูกถาม", en: "asked" },
  "trace.emptyOnly": { th: "ที่ไม่เจอ", en: "found nothing" },
  "trace.errorsOnly": { th: "ที่พัง", en: "errors" },
  "trace.prune": { th: "ลบที่เก่ากว่า 30 วัน", en: "prune > 30 days" },
  "trace.clear": { th: "ล้างทั้งหมด", en: "clear all" },
  "trace.clearConfirm": { th: "ลบ {n} แถวจริง", en: "really delete {n}" },
  "trace.forget": { th: "ลืม “{k}”", en: "forget “{k}”" },
